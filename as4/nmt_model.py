...
class NMT(nn.Module):
    ...
    def decode(self, enc_hiddens: torch.Tensor, enc_masks: torch.Tensor,
        ...
        for Y_t in torch.split(Y, 1):
            ...
            dec_state, o_t, e_t = self.step(Ybar_t, dec_state=dec_state,
    ...
    def step(self, Ybar_t: torch.Tensor,
        ...
        alpha_t = F.softmax(e_t, dim=1) #sum across each row aka batch

        # alpha_t is (b, src_len); enc_hiddens is (b, src_len, 2)
        # a_t should be (b, 2h)
